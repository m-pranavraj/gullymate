...
- teamA: string or null (set team name when user says "Team A is <NAME>" or "Team A name is <NAME>")
...
3. "Team A name is <NAME>" or "Team A is <NAME>" → teamA:"<NAME>"  (ALWAYS set team name, NEVER treat as a player)
4. "Team B name is <NAME>" or "Team B is <NAME>" → teamB:"<NAME>"  (ALWAYS set team name)
5. "Team A players ARE X, Y, Z" → action:"setTeamA", playersA:[...] (REPLACE all existing players)
6. "ADD X, Y, Z to Team A" → action:"addToTeamA", playersA:[...] (APPEND to existing players)
...
- "Team A name is VK Boys" → {teamA:"VK Boys"}
- "Team A name is Santosh" → {teamA:"Santosh"}
- "Team B name is Rahul" → {teamB:"Rahul"}
- "Team A name is Weekend Warriors" → {teamA:"Weekend Warriors"}
- "Team A name is Pranav" → {teamA:"Pranav"}
